                            ...
                            <div class="product-box">
                                <div class="product-img">
                                    <a href="restaurant.html">
                                        <img src="{{ asset('styleWeb/assets/img/restaurants/255x150/shop-10.jpg') }}"
...
<div class="product-footer-2">
    ...
    <div class="discount-coupon"> <span class="text-light-white fs-12">First order
            only</span>
    </div>
</div>
</div>
...
<div class="swiper-slide">
    <div class="product-box">
        <div class="product-img">
            <a href="restaurant.html">
                <img src="{{ asset('styleWeb/assets/img/restaurants/255x150/shop-11.jpg') }}"
                    class="img-fluid full-width" alt="product-img">
            </a>
        </div>
        <div class="product-caption">
...
<div class="swiper-slide">
    <div class="product-box">
        <div class="product-img">
            <a href="restaurant.html">
                <img src="{{ asset('styleWeb/assets/img/restaurants/255x150/shop-22.jpg') }}"
                    class="img-fluid full-width" alt="product-img">
            </a>
        </div>
        <div class="product-caption">
...
<div class="swiper-slide">
    <div class="product-box">
        <div class="product-img">
            <a href="restaurant.html">
                <img src="{{ asset('styleWeb/assets/img/restaurants/255x150/shop-23.jpg') }}"
                    class="img-fluid full-width" alt="product-img">
            </a>
        </div>
        <div class="product-caption">
...
<div class="swiper-slide">
    <div class="product-box">
        <div class="product-img">
            <a href="restaurant.html">
                <img src="{{ asset('styleWeb/assets/img/restaurants/255x150/shop-24.jpg') }}"
                    class="img-fluid full-width" alt="product-img">
            </a>
        </div>
        <div class="product-caption">
