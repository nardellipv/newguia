                                ...
                                <div class="step-content">
                                    <div class="step-tab-panel active" id="steppanel1">
                                        <div class="general-sec">
                                            <form method="post" action="{{ route('commerce.updateCommerceStep2', $commerce->slug) }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="province_id" required
                                                                ...
                                                                <option value="{{ $commerce->province_id }}">
                                                                    {{ $commerce->province->name }}</option>
                                                                @else
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="region_id" required
                                                                class="form-control form-control-submit custom-select-2 full-width">
                                                                <option value="{{ $commerce->region_id }}">
                                                                    {{ $commerce->region->name }}</option>
