                                    ...
                                    <div class="step-tab-panel active" id="steppanel1">
                                        <div class="general-sec">
                                            <form method="post" action="{{ route('product.update', $product) }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h5 class="text-light-black fw-700">Editar Producto</h5>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-light-black fw-700">Precio
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" name="description" required
                                                                ...
                                                                class="form-control form-control-submit">{{ old('description', $product->description) }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
