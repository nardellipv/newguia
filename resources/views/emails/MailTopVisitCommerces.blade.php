                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        <strong><span style="font-size: 30px;">Hola {!!
                                                                $commerce->user->name !!}, </span></strong></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, sans-serif"><![endif]-->
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 18px;">Te estamos enviando este email
                                                            desde guiaceliaca.com.ar para compartirte la siguiente
                                                            información.</span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p dir="ltr"
                                                        ...
                                                        Tu comercio dentro de la plataforma guiaceliaca.com.ar es el más
                                                        visitado entre todos lo que integran nuestro sitio.</p>
                                                    <p dir="ltr"
                                                        style="margin: 0; font-size: 18px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 22px; margin-top: 0; margin-bottom: 0;">
                                                         </p>
                                                    <p dir="ltr"
                                                        ...
                                                        <span style="color: #f11414;"><strong><span
                                                                    style="font-size: 28px;">FELICITACIONES!!!</span></strong></span>
                                                    </p>
                                                    <p dir="ltr"
                                                        style="margin: 0; font-size: 18px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 22px; margin-top: 0; margin-bottom: 0;">
                                                         </p>
                                                    ...
                                                    <p dir="ltr"
                                                        style="margin: 0; font-size: 18px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 22px; margin-top: 0; margin-bottom: 0;">
                                                        Te recomendamos que respondas los mensajes de los usuarios del
                                                        sitio lo                   antes posible. Puede que ganes nuevos
                                                        clientes y te recomienden.</p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <!--[if (!mso)&(!IE)]><!-->
